  ...
  "https://api.groq.com/openai/v1/chat/completions",
  {
    ...
    body: JSON.stringify({
      ...
      messages: [
        {
          role: "system",
          content: `You are a medical document extraction engine.
      ...
      <div style={{background:"white",borderBottom:"1px solid #e5e7eb",padding:"0 24px",position:"sticky",top:0,zIndex:10}}>
        ...
        {showApiInput && (
          <div style={{maxWidth:1100,margin:"0 auto",paddingBottom:12,display:"flex",gap:8,alignItems:"center"}}>
            <input style={{...IS.style,maxWidth:420,fontSize:12}} type="password" placeholder="Paste Groq API key (gsk_...) for document extraction" value={apiKey} onChange={e=>setApiKey(e.target.value)} />
            ...
            <span style={{fontSize:11,color:"#9ca3af"}}>Key stays in browser only — never sent anywhere except Groq</span>
          </div>
        )}
      </div>
